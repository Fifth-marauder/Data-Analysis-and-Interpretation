...
In the Python script I used the frequency tables to access the number of NAs in my data subset (and because they were required in the course). In R, to see the number and general distribution of my values of interest, I would simply look at a data summary.
